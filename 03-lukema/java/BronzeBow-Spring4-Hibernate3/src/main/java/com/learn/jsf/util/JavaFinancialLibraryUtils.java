...
{
   protected static final Logger          LOG                      = Logger.getLogger(JavaFinancialLibraryUtils.class);

   private static final long              ThreadTimeOutMiliseconds = 400;

   private static final long              KeepAliveTime            = 500;

   public static final ThreadPoolExecutor QuoteThreadPoolExecutor  = new ThreadPoolExecutor(6, 6, KeepAliveTime, TimeUnit.MILLISECONDS,
