...
## 2. Add the following to `C:\Windows\System32\drivers\etc\hosts`:
    ...
    #
    192.168.1.200    ubuntu-k8s-master  ubuntu-k8s-master.learn.com
    192.168.1.201    lma-k8s-worker1    lma-k8s-worker1.learn.com
...
## 4. `/etc/hosts` ports:
    ...
    ubuntu-k8s-master:  192.168.1.200
    lma-k8s-worker1: 192.168.1.201
