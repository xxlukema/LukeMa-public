...
@Log4j2
public class GoogleSearchPageObjectModel {

    private WebDriver webDriver = null;

    private By input_text_search = By.name("q");

    public GoogleSearchPageObjectModel(WebDriver webDriver) {
    ...
    public void sendInputText(String searchText) {
        this.webDriver.findElement(input_text_search).sendKeys(searchText);
    }

    public void sendKeys(Keys keys) {
        this.webDriver.findElement(input_text_search).sendKeys(keys);
    }
