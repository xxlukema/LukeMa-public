...
public class TradeServiceImpl
    ...
    public void buyStock(Customer customer, String symbol, int sharesBought, float purchasePrice)
        ...
        if (portfolio != null) {
            ...
            LOG.info("cash=" + cash + ",sharesBought=" + sharesBought + ",purchasePrice=" + purchasePrice);
            ...
            customerDAO.saveOrUpdate(portfolioItem);
    ...
    public void sellStock(Customer customer, String symbol, int sharesSold, float sellPrice)
        ...
        if (portfolio != null) {
            ...
            LOG.info("cash=" + cash + ",sharesSold=" + sharesSold + ",sellPrice=" + sellPrice);
            ...
            if (sharesLeft == 0) {
                ...
                customerDAO.delete(portfolioItem);
            } else {
    ...
    public List<PortfolioItem> getInitializedPortfolioItems(Customer customer) {
        ...
        for (PortfolioItem portfolioItem : list) {
            ...
            try {
                ...
                LOG.error("****** Exception with JavaFinancialLibraryUtils.getQuote(symbol) for symbol = " + symbol + ". " + e.getMessage());
            }
        }
