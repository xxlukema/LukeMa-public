...
public class LookupConstants
{
   ...
   public static final String   ESB_WS_QUEUE_NAME                   = "/queue/EsbHelloWorld_Request_esb";

   public static final String   ESB_GW_QUEUE_NAME                   = "/queue/EsbHelloWorld_Request_gw";

   public static final String   ESB_QUEUE_NAME                      = "/queue/EsbHelloWorld_Request";
