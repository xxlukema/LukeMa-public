...
public class GreetingController {
    ...
    public ResponseEntity<Greeting> greeting(@RequestParam(required = false) String user) {

        Assert.hasText("25", age);
        Assert.hasText("Luke", name);

        log.info("GreetingController ::: name: {}, age: {}, user: {}", () -> name, () -> age, () -> user);
        ...
        return ResponseEntity.status(HttpStatus.OK).body(new Greeting(counter.incrementAndGet(), String.format(TEMPLATE, greet)));
    }
