...
import com.learn.rest.controller.PingNoSecurityController;
...
public class SwaggerConfig {
    ...
    private final boolean isPingEnabled = true;
    ...
    private List<SecurityReference> pingSecurityAuthRef() {
        ...
        securityReferences.add(new SecurityReference(API_KEY_NAME, authorizationScopes));
