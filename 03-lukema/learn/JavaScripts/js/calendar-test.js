...
document.write('<iframe id="calendarf" name="calendarf" frameborder="0" style="position:absolute;width:162px;height:180px;"></iframe>');
document.write('<div id="fcc" style="position:relative;width:162px;height:180px;">');  
...
function closeCalendar()
{
   ...
   //getObj('calendarf').style.visibility='hidden';
   //getObj('calendarf').style.display='none';
