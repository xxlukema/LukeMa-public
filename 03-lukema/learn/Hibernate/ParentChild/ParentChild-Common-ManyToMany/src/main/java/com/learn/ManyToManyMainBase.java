...
public class ManyToManyMainBase
{
   private static final Logger LOG = Logger.getLogger(ManyToManyMainBase.class);
   ...
   public static void retrieveParents()
   {
      ...
      try
      {
         ...
         for (Parent parent : parents)
         {
            ...
            LOG.info(parentName + " has " + children.size() + " child/children.");
   ...
   public static void retrieveChildren()
   {
      ...
      try
      {
         ...
         for (Child child : children)
         {
            ...
            Collection<Parent> parents = child.getParents();
            LOG.info(childName + " has " + parents.size() + " parent(s).");
