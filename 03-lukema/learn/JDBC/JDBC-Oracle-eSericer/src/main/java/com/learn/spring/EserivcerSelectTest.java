...
public class EserivcerSelectTest {
    protected static final Logger LOG = Logger.getLogger(EserivcerSelectTest.class);
    ...
    public void selectProcReportsWatchList()
        throws Exception {
        LOG.info("selectProcReportsWatchList()");
    ...
    public void selectProcReportWatchListLoad()
        throws Exception {
        LOG.info("selectProcReportWatchListLoad()");
