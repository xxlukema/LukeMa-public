...
Suppose every senator is smart enough and will play the best strategy for his own party. Predict which party will finally announce the victory and change the
...
public class Dota2Senate {
    ...
    public static void main(String[] args) {
        ...
        var ret = dota2Senate.predictPartyVictory(senate);
        log.debug("Dota2 Senate: {}", () -> ret);
        Assertions.assertEquals(expected, ret);
        log.debug("Dota2 Senate: {} OK", () -> "predictPartyVictory");
     ...
     * Space: O(n)
     *
     * Runtime: 9 ms Beats 95.31%
     * Memory: 43.3 MB Beats 85.51%
     */
    public String predictPartyVictory(String senate) {
         ...
         * build Queue
         */
        for (int i = 0, len = senate.length(); i < len; i++) {
