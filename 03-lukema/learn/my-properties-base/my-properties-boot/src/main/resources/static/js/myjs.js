...
$(function () {
	...
	const dateUpdatedUrl = "/rest/house/getDateUpdated";
	const propertyListUrl = "/rest/house/getPropertyList";
			...
			success: function( data ) {
				if(data != null) {
					...
					$.each(data, function(index, value) {
						...
						html += '  <tr><td><label class="lableAlignRight">Interest Rate</label></td><td style="text-align: right;"><span class="spanValue percent">' + value["interestRate"] + '</span></td><td></td></tr>';
						html += '  <tr><td><label class="lableAlignRight">Maturity Date</label></td><td style="text-align: right;"><span class="spanValue">' + value["maturityDate"] + '</span></td><td></td></tr>';
						...
						html += '  <tr><td>&nbsp;</td><td>&nbsp;</td><td></td></tr>';
						html += '  <tr><td><label class="lableAlignRight payment">Monthly County Property Tax</label></td><td><span class="spanValue currency number payment">' + value["monthlyCountyPropertyTax"] + '</span></td><td>(Covered by Escrow)</td></tr>';
						...
						html += '  <tr><td><label class="lableAlignRight payment bold">Actual Monthly Escrow</label></td><td><span class="spanValue currency number payment bold">' + value["actualMonthlyEscrow"] + '</span></td><td>(vs. Calculated Escrow: <span class="spanValue currency number">' + value["calculatedMonthlyEscrow"] + '</span>)</td></tr>';
						html += '  <tr><td>&nbsp;</td><td>&nbsp;</td><td></td></tr>';
