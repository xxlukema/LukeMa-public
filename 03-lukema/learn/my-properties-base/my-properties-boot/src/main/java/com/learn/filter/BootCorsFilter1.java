...
public class BootCorsFilter1
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
        ...
        log.info("============== accessControlAllowOrigin {}", () -> accessControlAllowOrigin);
        ...
        if (!"none".equals(accessControlAllowOrigin)) {
            ...
            res.setHeader("Access-Control-Allow-Headers", "X-Requested-With, WWW-Authenticate, Authorization, Origin, Content-Type, Version");
