...
import com.learn.eshop.repository.ProductCacheableRepository;
...
public class ProductController {
    ...
    public ProductController(ProductCacheableRepository productRepository) {
    ...
    public ProductDto products(@PathVariable String productId)
        throws InterruptedException {
        return productRepository.getProduct(productId).get();
    }

    @PostMapping(value = "/products")
    public ResponseEntity<ProductDto> addProduct(@RequestBody ProductDto productDto) {
        return ResponseEntity.status(HttpStatus.CREATED).body(productRepository.addProduct(productDto));
    }

    @PutMapping(value = "/products/{productId}")
    public ResponseEntity<ProductDto> updateProduct(@PathVariable String productId, @RequestBody ProductDto productDto) {
        return ResponseEntity.status(HttpStatus.CREATED).body(productRepository.updateProduct(productId, productDto));
    }
}
