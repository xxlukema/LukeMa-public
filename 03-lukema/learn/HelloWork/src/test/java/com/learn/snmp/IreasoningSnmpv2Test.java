...
@Log4j2
public class IreasoningSnmpv2Test {
    ...
    public void testMibUtils()
        ...
        final int port = 161;
        final String host = "localhost", readCommunity = "read", version = "2c";
        // final String writeCommunity = "public";

        SnmpTarget target = new SnmpTarget(host, port, readCommunity, version);
