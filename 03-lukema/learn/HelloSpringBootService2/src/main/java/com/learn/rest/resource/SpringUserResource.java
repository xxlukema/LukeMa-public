...
@RestController
public class SpringUserResource {
    ...
    @GetMapping(value = "/get/{username}", consumes = { MediaType.APPLICATION_JSON }, produces = { MediaType.APPLICATION_JSON })
