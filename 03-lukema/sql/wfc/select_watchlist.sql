...
SELECT
    ...
    ,W.LOAN_ID,12,2012)) "MATURITY_DT",
    PKG_CMSA_FUNCTIONS.SP_CMSA_CROSSCOLLNCFLN_FNC(W.LOAN_ID,1,'AN',771,12,
    2012)                                                   "FISCAL_YR_DSCRNCF",
    PKG_CMSA_Functions.Sp_Cmsa_Datefrmt_Fnc(T4.FISCAL_YR_END_YRMM) "FISCAL_YR_END_YRMM", --L58
    ...
    Sp_Cmsa_Loan_Refcd_Criteria(W.LOAN_ID,'17-DEC-12')                                  "REFCD_CRITERIA"
    ,
    W.COMMENTS
FROM
    (
    ...
    (
        ...
        FROM
            ...
            (
                ...
                AND Feed_Dt BETWEEN '13-OCT-12' AND '17-DEC-12'
...
AND NOT EXISTS
    (
        ...
        WHERE
            LOAN_ID=P.LOAN_ID
        AND TRANSFER_DT<'17-DEC-12'
        AND (
                RETURN_DT IS NULL
            OR  RETURN_DT>'17-DEC-12') )
AND W.EFFECTIVE_DT<='17-DEC-12'
AND (
...
AND W.LOAN_ID NOT IN
    (
        ...
        AND DEFEASANCE_CD = 'F' )
AND P.INVESTOR_ID=771
AND Sp_Cmsa_Loan_Refcd_Criteria(W.LOAN_ID,'17-DEC-12') IS NOT NULL;
