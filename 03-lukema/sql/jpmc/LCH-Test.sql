...
select * 
from CS_STG_LCH_MTM
where SOURCE_FEED_NAME = 'LCHEMEAMTMJPMSL'
and rownum < 20
order by COB_DATE desc;
...
--delete from CS_CH_MTM where cob_date = to_date('2011-03-28', 'YYYY-MM-DD');

--delete from CS_CH_IA where cob_date = to_date('2011-03-29', 'YYYY-MM-DD');
