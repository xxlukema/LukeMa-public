...
DECLARE
    ...
    DECLARE
        ...
        AND CMSF.CalendarId = @Calendar
        LEFT OUTER JOIN
            FILENETDOCUMENTS FND (NOLOCK)
        ON
            FND.CalendarId = @Calendar
        ...
        LEFT OUTER JOIN
            APPUSERINFO APP (NOLOCK)
        ON
            APP.Userid = X.Userid
        LEFT OUTER JOIN
            APPUSERINFO APP1 (NOLOCK)
        ON
            APP1.Userid = I.PSRAnalyst
        LEFT OUTER JOIN
            APPUSERINFO APP2 (NOLOCK)
        ON
            APP2.Userid = I.AssetManager
        LEFT OUTER JOIN
            APPUSERINFO APP3 (NOLOCK)
        ON
