ALTER PROCEDURE "dbo"."USP_RptPMMRRA" (@Client INT,
...
WITH
    ...
    (
        SELECT
            ROV.RentRollID ,
            CASE
                WHEN DATEDIFF(MONTH, CONVERT(VARCHAR(10), GETDATE(), 101), CONVERT(VARCHAR(10),
                    RRD.EndDate, 101)) < 7
                THEN 'Expiring0to6Months'
                WHEN DATEDIFF(MONTH, CONVERT(VARCHAR(10), GETDATE(), 101), CONVERT(VARCHAR(10),
                    RRD.EndDate, 101)) > 6
                AND DATEDIFF(MONTH, CONVERT(VARCHAR(10), GETDATE(), 101), CONVERT(VARCHAR(10),
                    RRD.EndDate, 101)) < 10
