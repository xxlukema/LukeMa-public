...
SELECT DISTINCT
            ...
            (
                ...
                AND dbo.fncCalIDToCal(PFSH.CALENDARID) = dbo.fncCalIDToCal(1)
            ...
            (
                ...
                WHERE
                    dbo.fncCalIDToCal(ass.CalendarID) = dbo.fncCalIDToCal(1)
        ...
        LEFT OUTER JOIN
            (
                ...
                WHERE
                    dbo.fncCalIDToCal(CAL.CALENDARID) = dbo.fncCalIDToCal(1)
