...
AS
    ...
    FROM
        rm_prod_sa.service_profile_phones spp, --- 245,293 rows
        rm_prod_sa.company_location cl, --- 40,965 rows
        vrd_guff.vz_bass_call_detail tg
    JOIN
        rm_prod_sa.intl_rate_code itrc
    ON
        (
    ...
    GROUP BY
        ...
        tg.billing_end_date $$ LANGUAGE SQL;
