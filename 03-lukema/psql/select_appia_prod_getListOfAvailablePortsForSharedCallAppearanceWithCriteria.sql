...
SELECT
    ...
    t8.LINEPORT,
    CASE
        WHEN (t6.CCUSERID = '2023034424@virtualcommexpress.verizon.com')
        THEN true
        ELSE false
    END
FROM
...
WHERE
    (((((((((
                            ...
                            AND (
                                    t10.ccgroupid = 'EVRZN32234L32417'))
                        AND (((
                                        t6.CCUSERID IS NULL)
                                OR  ((
                                            t6.CCUSERID <>
                                            '2023034424@virtualcommexpress.verizon.com')
                                    AND (
                                            t8.LOGICALPORTNUM = '1')))
                            OR  (
                                    t6.CCUSERID = '2023034424@virtualcommexpress.verizon.com')))
                    AND t2.ID NOT IN
                                      (
                                      SELECT DISTINCT
                                          t11.ID
                                      ...
                                      WHERE
                                          (((
                                                      t15.ccgroupid = 'EVRZN32234L32417')
                                              AND (
                                                      t18.CCUSERID =
                                                      '2023034424@virtualcommexpress.verizon.com'))
                                          AND ((((((
                ...
                AND t2.ID NOT IN
                                  ...
                                  WHERE
                                      ((((
                                                      ...
                                                      '2023034424@virtualcommexpress.verizon.com')
                                              AND (
                                                      t24.ccgroupid = 'EVRZN32234L32417'))
                                          AND (
        ...
        AND t6.CCCALLINGLINELASTNAME LIKE '%%')
    AND ((((
